...
class AdminPostsController extends Controller
{
    ...
    public function uploadAudio($audioFile, $storagePath)
    {
        $fileName = time() . '_' . $audioFile->getClientOriginalName();
        $filePath = $audioFile->storeAs($storagePath, $fileName, 'public');
    ...
    public function store(Request $request)
    {
        ...
        if ($inputs['featured_audio']) {
            $audio_path = $this->uploadAudio($inputs['featured_audio'], 'images/audio');
            $inputs['featured_audio'] = $audio_path;
        }
